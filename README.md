...
2. Update the Blynk credentials at the very top of the script with your Web Dashboard parameters:
   ```cpp
   #define BLYNK_TEMPLATE_ID "TMPLxxxxxxxxxxx"
   #define BLYNK_TEMPLATE_NAME "Water Level"
   #define BLYNK_AUTH_TOKEN "YourAuthToken"
   ```
3. Update your Wi-Fi credentials (must be a 2.4GHz network):
   ```cpp
   char ssid[] = "YourWiFiName";
   char pass[] = "YourWiFiPassword";
   ```
4. Flash to your ESP32 and open the Serial Monitor at `115200` baud.
